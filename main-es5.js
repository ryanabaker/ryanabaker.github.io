...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppMatrixMatrixComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div class=\"center\" id=\"sketch-holder\"></div>\n";
    /***/
  },
    ...
    function () {
      function Particle(p, x, y, flag, hu, hFlag) {
        ...
        if (this.fireworkFlag) {
          ...
          if (hFlag) {
            var i = this.p.random(0, 360); // do the shape of fireworks here
            // size is here
    ...
    function () {
      ...
      _createClass(Particle, [{
        ...
        value: function show() {
          ...
          this.updatePrev(); // this.p.point(this.pos.x, this.pos.y);
        }
      }, {
        key: "updatePrev",
          ...
          p.draw = function () {
            ...
            for (var _i2 = 0; _i2 < cols - 1; _i2++) {
              for (var _j2 = 0; _j2 < rows - 1; _j2++) {
                ...
                var state = 8 * field[_i2][_j2].val + 4 * field[_i2 + 1][_j2].val + 2 * field[_i2 + 1][_j2 + 1].val + field[_i2][_j2 + 1].val;
                p.strokeWeight(1);
                p.stroke(255);
